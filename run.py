...
# OS file paths
# Use / to avoid errors caused by \ in the path string (issues with this persisted across different systems, / works on Linux and Windows)
...
player_walk_2_path      = os.path.join(cwd, "graphics/player/player_walk_2.png")
player_jump_path        = os.path.join(cwd, "graphics/player/jump.png")
snail_frame_1_path      = os.path.join(cwd, "graphics/snail/snail1.png")
snail_frame_2_path      = os.path.join(cwd, "graphics/snail/snail2.png")
fly_frame_1_path        = os.path.join(cwd, "graphics/bug/bug1.png")
fly_frame_2_path        = os.path.join(cwd, "graphics/bug/bug2.png")
player_stand_path       = os.path.join(cwd, "graphics/player/player_stand.png")
